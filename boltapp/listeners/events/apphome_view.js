    ...
    blocks.push(
      ...
      { type: 'divider' },
      {
        ...
        accessory: {
          ...
          style: 'primary',
          value: 'clicked',
          action_id: 'download_user_operating_history_button',
          url: `http://${config.GLOBAL_APPAPI_HOST}/trouble_user_operating_history_download/?bot_name=${config.BOT_NAME}&tz_offset=${userinfo.user.tz_offset}`,
        },
      },
      { type: 'divider' },
      {
